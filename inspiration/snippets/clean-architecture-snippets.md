...
## Snippet 0: Clean Architecture Layers Have Correct Dependencies
...
## Snippet 1: Classes With 'UseCase' Suffix Should Reside In 'domain' And 'usecase' Packages
...
## Snippet 2: Classes With 'UseCase' Suffix Should Have Single Public Method Named 'invoke'
...
## Snippet 3: Interfaces With 'Repository' Annotation Should Reside In 'data' Package
